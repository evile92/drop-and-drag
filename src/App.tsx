...
function TransparentTape() {
  return (
    <div className="absolute top-[38%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-28 md:w-36 h-8 md:h-10 z-30 pointer-events-none select-none opacity-95 rotate-[-4deg] overflow-hidden">
